	...
	return (
		...
		>
			...
			>
				...
				>
					<h3 className='mb-2 font-semibold text-indigo-200 text-lg'>Powered by Drizzle ORM</h3>
					...
					<div className='space-y-2 text-sm'>
						...
						<ol className='list-inside list-decimal space-y-2 text-indigo-300/80'>
							<li>
								Configure your{" "}
								<code className='rounded bg-black/30 px-2 py-1 text-purple-300'>DATABASE_URL</code> in
								.env.local
							</li>
							<li>
								Run:{" "}
