		...
		<main className='page-wrap px-4 pt-14 pb-8'>
			<section className='island-shell rise-in relative overflow-hidden rounded-[2rem] px-6 py-10 sm:px-10 sm:py-14'>
				...
				<p className='mb-8 max-w-2xl text-[var(--sea-ink-soft)] text-base sm:text-lg'>
					This base starter intentionally keeps things light: two routes, clean structure, and the essentials
			...
			<section className='island-shell mt-8 rounded-2xl p-6'>
				...
				<ul className='m-0 list-disc space-y-2 pl-5 text-[var(--sea-ink-soft)] text-sm'>
					...
					<li>
						Update <code>src/components/Header.tsx</code> and <code>src/components/Footer.tsx</code> for
						brand links.
					</li>
					<li>
